...
import { acceptOrDecline, addChatToProject, addExpenses, addRemainders, addResumeToProject, addTrainer, checkListUpdate, client_amount_dueDate, client_invoice_sent, createProject, deleteTrainer, getAllNotes, getExpenses, getOngoingProjects, getProject, getProjectDetails, getProjectForTrainer, getProjectsByEmp, getRemainders, isClientCallDone, isFinalizedController, savePurchaseOrder, updateInvoice_by_paid, updateLost_Won, updateStage, updateTraining, upload_Invoice_Url_Trainer, uploadPOUrl_Trainer } from '../controllers/ProjectController.js';
