...
import { addEmployee, getEmployeeById, getAllEmployees, updateEmployeeRole, getAllTrainers, getEmployee, getAllKeysAccounts, getAllTrainerSourcer } from '../controllers/AdminController.js';
...
router.get("/getkeyAccounts", authEmployeeMiddleware, authorizeRole(["ADMIN"]), getAllKeysAccounts)
router.get("/gettrainerSourcer", authEmployeeMiddleware, authorizeRole(["ADMIN"]), getAllTrainerSourcer)
