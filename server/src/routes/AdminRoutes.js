...
import { addEmployee, getEmployeeById, getAllEmployees, updateEmployeeRole, getAllTrainers, getEmployee, getAllKeysAccounts, getAllTrainerSourcer, disableEmployeeRole, findTrainersByName } from '../controllers/AdminController.js';
...
router.get("/getTrainersByNameOrEmail", authEmployeeMiddleware, authorizeRole(["ADMIN", "KeyAccounts", "TrainerSourcer"]), checkRoleStatus(["ADMIN", "KeyAccounts", "Trainer Sourcer"]), findTrainersByName)
