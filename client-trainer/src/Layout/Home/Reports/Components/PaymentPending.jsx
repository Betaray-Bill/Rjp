...
function PendingPayment() {
    ...
    const submitHandler = async() => {
        ...
        try {
            ...
            const response = await api.get(`/reports/trainer/pending/payment/${user._id}?${params.toString()}`);
    ...
    return (
        <div className='mt-2 pt-2'>
            <div className='flex items-center justify-between'>
                <div className='font-semibold'>Pending Payment</div>
                    ...
                    {projects
                        ?.map((e, _i) => (
                            <TableRow key={e.projectId}>
                                ...
                                <TableCell>{e.trainingName}</TableCell>
            ...
            </Table> : <div className='items-center text-sm grid place-content-center mt-2z'>No Pending Payments</div>
}
